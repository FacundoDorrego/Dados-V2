...
int main(){
    ...
    srand(time(0));
    int dado1[6];
    int ronda=1,puntajeRonda=0,puntajeRonda2=0,puntajeTotal=0,puntajeTotal2=0,puntajeTotalMax=0,suma=0,resultado=0,numM,numJugadores,accion=1;
    ...
    char nombreJug[10],nombreJug2[10],nombreJugMax[10],opcion,decision;
    //Ronda
    while(fin!=true){
